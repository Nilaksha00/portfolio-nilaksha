  ...
  return (
    ...
    >
      ...
      {experiencesData.map((i, index) => (
        ...
        >
          <a
            href={i.link} // Replace i.url with the actual URL for each item
            target="_blank"
            rel="noopener noreferrer"
            className="block p-4 md:p-12 h-full w-full transition-transform transform duration-300 ease-in-out"
          >
